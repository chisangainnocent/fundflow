                ...
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="grid sm:grid-cols-3 gap-6">
                        ...
                        <button
                            ...
                            className="bg-white p-6 py-5 rounded-lg shadow hover:shadow-lg text-left border-l-4 border-blue-600"
                        >
                        ...
                        <button
                            ...
                            className="bg-white p-6 py-5 rounded-lg shadow hover:shadow-lg text-left border-l-4 border-green-600"
                        >
                        ...
                        <button
                            ...
                            className="bg-white p-6 py-5 rounded-lg shadow hover:shadow-lg text-left border-l-4 border-purple-600"
                        >
                        ...
                        <button
                            ...
                            className="bg-white p-6 py-5 rounded-lg shadow hover:shadow-lg text-left border-l-4 border-yellow-500"
                        >
                        ...
                        <button
                            ...
                            className="bg-white p-6 py-5 rounded-lg shadow hover:shadow-lg text-left border-l-4 border-orange-500"
                        >
                            <h3 className="text-md font-semibold">📁 Compliance Tracker</h3>
                            <p className="text-sm text-gray-600 mt-1">
                                ZRA and Pacra compliance part
                            </p>
                        </button>
                        ...
                        <button
                            ...
                            className="bg-white p-6 py-5 rounded-lg shadow hover:shadow-lg text-left border-l-4 border-red-500"
                        >
                        ...
                        <button
                            ...
                            className="bg-white p-6 py-5 rounded-lg shadow hover:shadow-lg text-left border-l-4 border-red-500"
                        >
                            <h3 className="text-md font-semibold">📊 Business Summary</h3>
                            <p className="text-sm text-gray-600 mt-1">
                                Showing the business Summary
                            </p>
                        </button>
                    </div>
                </div>
